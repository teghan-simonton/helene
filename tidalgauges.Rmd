...
#preditions are all following similar pattern
```



#Note: all data imported with these parameters: product = water_level; datum = MHHW; time_zone = lst_ldt; dates are the storm and a month prior for debby; before and after for all other storms

```{r}
#import tidal gauge data for debby 

#st pete

download.file("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?begin_date=20240801&end_date=20240807&station=8726520&product=water_level&datum=MHHW&time_zone=lst_ldt&units=english&format=csv", destfile = "downloads/stpete.csv")

download.file("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?begin_date=20240801&end_date=20240807&station=8726520&product=predictions&datum=MHHW&time_zone=lst_ldt&units=english&format=csv", destfile = "downloads/stpete_prediction.csv")
...
download.file("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?begin_date=20240801&end_date=20240807&station=8726607&product=water_level&datum=MHHW&time_zone=lst_ldt&units=english&format=csv", destfile = "downloads/opt.csv")

download.file("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?begin_date=20240801&end_date=20240807&station=8726607&product=predictions&datum=MHHW&time_zone=lst_ldt&units=english&format=csv", destfile = "downloads/opt_prediction.csv")
...
download.file("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?begin_date=20240801&end_date=20240807&station=8726384&product=water_level&datum=MHHW&time_zone=lst_ldt&units=english&format=csv", destfile = "downloads/portmanatee.csv")

download.file("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?begin_date=20240801&end_date=20240807&station=8726384&product=predictions&datum=MHHW&time_zone=lst_ldt&units=english&format=csv", destfile = "downloads/portmanatee_prediction.csv") 
...
download.file("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?begin_date=20240801&end_date=20240807&station=8726724&product=water_level&datum=MHHW&time_zone=lst_ldt&units=english&format=csv", destfile = "downloads/clearwater.csv")

download.file("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?begin_date=20240801&end_date=20240807&station=8726724&product=predictions&datum=MHHW&time_zone=lst_ldt&units=english&format=csv", destfile = "downloads/clearwater_prediction.csv") 
...
download.file("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?begin_date=20240801&end_date=20240807&station=8726674&product=water_level&datum=MHHW&time_zone=lst_ldt&units=english&format=csv", destfile = "downloads/ebt.csv")

download.file("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter?begin_date=20240801&end_date=20240807&station=8726674&product=predictions&datum=MHHW&time_zone=lst_ldt&units=english&format=csv", destfile = "downloads/ebt_prediction.csv") 
...
idalia %>% 
  ...
  arrange(desc(difference))
```
#check to see if other monitors have peaked too
...
helene %>% 
  ...
  select(date_time, water_level, prediction) %>% 
  mutate(difference = water_level - prediction) %>% 
  arrange(desc(difference)) #6.202 surge

december %>% 
  filter(station == "St. Pete") %>% 
  select(date_time, water_level, prediction) %>% 
  mutate(difference = water_level - prediction) %>% 
  arrange(desc(difference)) #idalia 4.6
```
```{r}
#pull highest measurement from each station during helene
